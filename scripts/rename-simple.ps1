# Script simple para renombrar archivos que contengan nombres en español
        ...
        try {
            ...
            foreach ($file in $files) {
                try {
                    ...
                    Write-Host "Error renombrando $($file.FullName)" -ForegroundColor Red
                    $errorCount++
            ...
            Write-Host "Error accediendo al directorio $searchDir" -ForegroundColor Red
        }
    }
        ...
        try {
            ...
            foreach ($file in $files) {
                try {
                    ...
                    Write-Host "Error revirtiendo $($file.FullName)" -ForegroundColor Red
                }
            }
        }
        catch {
