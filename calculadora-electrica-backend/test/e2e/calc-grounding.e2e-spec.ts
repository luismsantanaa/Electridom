  ...
  describe('POST /calc/grounding/preview', () => {
    ...
    it('should size grounding system for residential installation', () => {
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(res.body.conductor_proteccion.type).toBe('EGC');
          expect(res.body.conductor_proteccion.section_mm2).toBe(10);
          expect(res.body.conductor_proteccion.calibre_awg).toBe('8');
          expect(res.body.conductor_tierra).toBeDefined();
          expect(res.body.conductor_tierra.type).toBe('GEC');
          expect(res.body.conductor_tierra.section_mm2).toBe(16);
    ...
    it('should size grounding system for commercial installation', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(200)
        .expect((res) => {
          expect(res.body.conductor_proteccion.section_mm2).toBe(25);
          expect(res.body.conductor_tierra.section_mm2).toBe(35);
    ...
    it('should size grounding system for industrial installation', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(200)
        .expect((res) => {
          expect(res.body.conductor_proteccion.section_mm2).toBe(95);
          expect(res.body.conductor_tierra.section_mm2).toBe(120);
    ...
    it('should handle high amperage breakers', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect(200)
        .expect((res) => {
          expect(res.body.conductor_proteccion.section_mm2).toBe(240);
          expect(res.body.conductor_tierra.section_mm2).toBe(300);
    ...
    it('should handle missing system field', () => {
      const invalidRequest = {
        feeder: {
          current_a: 61.8,
          section_mm2: 10,
    ...
    it('should handle missing feeder field', () => {
      const invalidRequest = {
        system: {
          voltage_v: 120,
          phases: 1,
    ...
    it('should handle missing parameters field', () => {
      const invalidRequest = {
        system: {
          voltage_v: 120,
          phases: 1,
