...
describe('InstallationTypesController', () => {
  let controller: InstallationTypesController;
  let service: InstallationTypesService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: InstallationTypesService,
          useValue: mockTiposInstalacionesService,
        },
      ],
    }).compile();

    controller = module.get<InstallationTypesController>(
      InstallationTypesController,
    );
    service = module.get<InstallationTypesService>(InstallationTypesService);
  });
  ...
  describe('create', () => {
    it('should create a new type installation', async () => {
      const createDto: CreateInstallationTypeDto = {
        id: '1',
  ...
  describe('update', () => {
    it('should update a type installation', async () => {
      const id = '1';
      const updateDto: UpdateInstallationTypeDto = {
