...
export class CreateTypeTables1755797078000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tipos_artefactos" DROP CONSTRAINT "FK_tipos_artefactos_environment_type"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tipos_ambientes" DROP CONSTRAINT "FK_tipos_ambientes_installation_type"`,
    );
