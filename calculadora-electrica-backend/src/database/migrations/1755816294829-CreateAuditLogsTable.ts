...
export class CreateAuditLogsTable1755816294829 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        try {
            await queryRunner.query(`ALTER TABLE \`loads\` DROP FOREIGN KEY \`FK_2fd25202f4542073677c451d9bd\``);
        } catch (error) {
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`observaciones\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`proyecto_id\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`activo\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`fechaCreacion\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`fechaActualizacion\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`creadoPor\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`actualizadoPor\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`tipo_ambiente_id\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`description\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`tipoSuperficie\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`largo\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`ancho\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`altura\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`nivel\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`proyecto_id\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`activo\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`fechaCreacion\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`fechaActualizacion\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`creadoPor\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`actualizadoPor\``);
        ...
        await queryRunner.query(`ALTER TABLE \`tipos_artefactos\` ADD \`description\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`tipos_ambientes\` ADD \`description\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`usr_create\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`usr_update\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`creation_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`update_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`active\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`name\` varchar(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`potencia\` decimal(10,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`usr_create\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`usr_update\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`creation_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`update_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`active\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`voltaje\``);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`voltaje\` decimal(10,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP FOREIGN KEY \`FK_e247dfac4e068b2266e787354a7\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`area\``);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`area\` decimal(10,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` CHANGE \`tipo_ambiente_id\` \`tipo_ambiente_id\` uuid NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`environment\` ADD CONSTRAINT \`FK_e247dfac4e068b2266e787354a7\` FOREIGN KEY (\`tipo_ambiente_id\`) REFERENCES \`tipos_ambientes\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`environment\` CHANGE \`tipo_ambiente_id\` \`tipo_ambiente_id\` uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`area\``);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`area\` float(12) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD CONSTRAINT \`FK_e247dfac4e068b2266e787354a7\` FOREIGN KEY (\`tipo_ambiente_id\`) REFERENCES \`tipos_ambientes\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`voltaje\``);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`voltaje\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`active\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`update_date\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`creation_date\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`usr_update\``);
        await queryRunner.query(`ALTER TABLE \`environment\` DROP COLUMN \`usr_create\``);
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`update_date\``);
        await queryRunner.query(`ALTER TABLE \`loads\` DROP COLUMN \`creation_date\``);
        ...
        await queryRunner.query(`ALTER TABLE \`tipos_ambientes\` DROP COLUMN \`description\``);
        ...
        await queryRunner.query(`ALTER TABLE \`tipos_artefactos\` DROP COLUMN \`description\``);
        ...
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`actualizadoPor\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`creadoPor\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`fechaActualizacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`fechaCreacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`activo\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`proyecto_id\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`nivel\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`altura\` float(12) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`ancho\` float(12) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`largo\` float(12) NULL`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`tipoSuperficie\` enum ('Rectangular', 'Circular', 'Triangular', 'Irregular') NOT NULL DEFAULT 'Rectangular'`);
        await queryRunner.query(`ALTER TABLE \`environment\` ADD \`description\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`tipo_ambiente_id\` uuid NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`actualizadoPor\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`creadoPor\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`fechaActualizacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`fechaCreacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`activo\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`proyecto_id\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`observaciones\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`loads\` ADD \`kwhMensual\` float(12) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` ADD CONSTRAINT \`FK_2fd25202f4542073677c451d9bd\` FOREIGN KEY (\`tipo_ambiente_id\`) REFERENCES \`tipos_ambientes\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
