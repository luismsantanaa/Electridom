...
export class CreateAllTables1755797078019 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` ADD CONSTRAINT \`FK_fa27c9568f9cc6a40e5d70040ba\` FOREIGN KEY (\`tipo_artefacto_id\`) REFERENCES \`tipos_artefactos\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`loads\` DROP FOREIGN KEY \`FK_fa27c9568f9cc6a40e5d70040ba\``);
