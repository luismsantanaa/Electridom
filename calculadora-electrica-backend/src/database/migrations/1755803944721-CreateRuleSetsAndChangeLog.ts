  ...
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`norm_rules\` DROP FOREIGN KEY \`FK_cc17c2122dafe78d7047f085038\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_308f3d208a460415bac8f734d9\` ON \`norm_rules\``,
    );
    await queryRunner.query(`ALTER TABLE \`norm_rules\` DROP COLUMN \`code\``);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_c067885c7e7db4809a530a6327\` ON \`rule_change_logs\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_0cc73966e03f28e2bbc9588c6f\` ON \`rule_sets\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_d6295046fbd05aa5a70283caac\` ON \`rule_sets\``,
    );
